...
@section('title')
Modifier une region - Données géographiques 
@endsection
        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('regions.index') }}">Liste des régions</a>
                    </li>
                    <li class="breadcrumb-item"><a href="{{ route('regions.create') }}">Editer</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Modifier une région</h5>

            </div>
            <div class="card-block">
                <form id="main" method="POST" action="{{ route('regions.update', $region->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="pays" class="form-control">
                                ...
                                @foreach($pays as $pay)
                                    <option value="{{ $pay->id }}" @if($pay->id == $region->pay->id) selected @endif>{{ $pay->name }}</option>
                                @endforeach
                            </select>
                            @error('pays')
                                <li style="color:red;">{{ $message }}</li>
