...
@section('title')
Modifier une batterie - Données géographiques 
@endsection
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Modifier une batterie</h5>
                <span>Bien vouloir<code>remplir tous</code>les<code>champs</code>!</span>

            </div>
            <div class="card-block">
                <form id="main" method="POST" action="{{ route('batteries.update', $batterie->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Type de batterie</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" id="name" value="{{ $batterie->name }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="courant" id="name" value="{{ $batterie->courant }}">
                            @error('courant')
                                <li style="color:red;">{{ $message }}</li>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="tension" id="name" value="{{ $batterie->tension }}">
                            @error('tension')
                                <li style="color:red;">{{ $message }}</li>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="duree_de_vie" id="name" value="{{ $batterie->duree_de_vie }}">
                            @error('duree_de_vie')
                                <li style="color:red;">{{ $message }}</li>
                            @enderror
                        </div>
