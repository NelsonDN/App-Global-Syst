...
@section('title')
Modifier une ville - Données géographiques 
@endsection
        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#">Editer</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form id="main" method="POST" action="{{ route('villes.update', $ville->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nom</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name" value="{{ $ville->name }}">
                            @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="coefCorrection" id="coef" value="{{ $ville->coefCorrection }}">
                            @error('name')
                                <li style="color:red;">{{ $message }}</li>
                            @enderror
                        </div>
                        ...
                        <div class="col-sm-10">
                            <select name="region" class="form-control">
                                ...
                                @foreach($regions as $region)
                                    <option value="{{ $region->id }}" @if($region->id == $ville->region->id) selected @endif>{{ $region->name }}</option>
                                @endforeach
                            </select>
                            @error('pays')
                                <li style="color:red;">{{ $message }}</li>
