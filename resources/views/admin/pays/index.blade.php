...
@section('title')
Ajouter un pays - Données géographiques 
@endsection
        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pays.create') }}">Ajouter</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form id="main" method="POST" action="{{ route('pays.store') }}" enctype="multipart/form-data">
                    @csrf
