        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('pays.index') }}">Liste des pays</a>
                    </li>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h5>Mdifier un pays</h5>
            </div>
            <div class="card-block">
                <form id="main" method="POST" action="{{ route('pays.update', $pay->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Nom</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name"value="{{ $pay->name }}">
                            @error('name')
                            ...
                            @foreach($pays as $pay)
                                <tr>
                                    ...
                                    <td text-align="align-items-center" >
                                        ...
                                        <a href="{{ route('pays.destroy', $pay->id )}}">
